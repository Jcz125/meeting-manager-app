...
public class UtilisateurController {
    ...
    public UtilisateurData getSalle(@RequestParam(value = "id") Integer id) {
        if (id == 0)
            return new UtilisateurData(id, "Bouthier", "Christophe", "littlegirl@gmail.com", "3630", false, 0, true);
        if (id == 1)
            return new UtilisateurData(id, "Oster", "Gérald", "littleboy@gmail.com", "3630", false, 0, true);
        return new UtilisateurData(id, "BG", "Clément", "jeff.bezos@amazon.com", "3630", false, 0, false);
    }
